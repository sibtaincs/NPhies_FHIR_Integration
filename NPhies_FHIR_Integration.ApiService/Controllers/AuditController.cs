...
[Authorize(Roles = "TECHNICAL_REVIEW_MANAGER,MEDICAL_REVIEW_MANAGER")]
 ...
 UnauthorizedAttempts = unauthorizedAttempts.Count,
  HighRiskActions = highRiskActions.Count,
    ...
    ComplianceScore = CalculateComplianceScore(allLogs.Count, unauthorizedAttempts.Count, highRiskActions.Count)
      };
...
// Helper method for compliance scoring
...
// Extension method for AuditController
public static class AuditControllerExtensions
{
   public static double CalculateComplianceScore(this AuditController controller, int totalLogs, int unauthorizedAttempts, int highRiskActions)
     {
    return ComplianceHelper.CalculateComplianceScore(totalLogs, unauthorizedAttempts, highRiskActions);
        }
}
