...
/// <summary>
/// TaskRequest entity - represents FHIR Task resource for request operations
/// Used for requesting actions like claim cancellation from provider to insurer
/// FHIR Resource: Task (Request variant)
/// </summary>
 ...
 /// Processing Status
  ...
  /// Get task summary
    ...
    public string GetSummary()
    {
        ...
        return $"Task ({GetCodeDisplay()}): {GetStatusDisplay()} - Reason: {reason}";
    }
